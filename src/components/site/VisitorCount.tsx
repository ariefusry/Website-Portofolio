 ...
 *
 * Ini penghitung, bukan analitik. Satu orang dari dua browser terhitung dua
 * kali, dan crawler yang menjalankan JavaScript ikut terhitung. Angka yang
 * bisa dipertanggungjawabkan ada di dashboard Vercel Analytics.
 */
export function VisitorCount() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 pt-5">
      <VisitorAvatars />
      <p className="m-0 rounded-full border border-dark-2/30 px-3.5 py-1.5 font-mono text-xs leading-none text-dark-2">
        {t(UI.visitedBy)}{" "}
